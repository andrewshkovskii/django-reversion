...
setup(name="django-reversion",
      ...
      license="BSD",
      description="An extension to the Django web framework that provides comprehensive version control facilities, with human readable diffs and celery backend to save revisions",
